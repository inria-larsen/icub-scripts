...
# First, legs joints are put in idle status for few milliseconds, for releasing the  internal stresses in the legs due to putting the robot on the floor. Then, 
